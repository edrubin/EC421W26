...
Create a new dataset that only includes individuals from the randomized NSW experiment (_i.e._, filter the data to only include observations where `data_id == 'NSW'`).
